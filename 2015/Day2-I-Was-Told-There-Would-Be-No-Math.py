...
for i in sizesArray:
    ...
    ribbonBox = splitSizes[0] * splitSizes[1] * splitSizes[2]
    # Sorting the array to find the smallest sizes of the box
    splitSizes = sorted(splitSizes)
    # Calculate the needed ribbon
    ribbonBox += (splitSizes[0] + splitSizes[0]) + (splitSizes[1] + splitSizes[1]) 
